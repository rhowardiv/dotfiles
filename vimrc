...
" "random word append"
nnoremap <Leader>ra :execute "normal a" . system("echo -n $(sort -R /usr/share/dict/words \| head -n 1)")<cr>
" "random word insert"
nnoremap <Leader>ri :execute "normal i" . system("echo -n $(sort -R /usr/share/dict/words \| head -n 1)")<cr>
